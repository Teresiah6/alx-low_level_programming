...
/**
 * isSpace - if char is space or not
 * @c: input char
 * Return: 1 true or0 not
 */
int isSpace(char c)
{
	return (c == ' ');
...
/**
 * startIndex - start index of non-space char
 * @s: input str                                              * @index: starting index
 ...
 * @str: str of words to be split
 * Return: double pointer to str
 */
